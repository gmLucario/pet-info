var htmx = function () {
    ...
    function Re(e, o, i, t) {
        ...
        if (r.length) {
            ...
            o.parentNode.removeChild(o);
            fe(te().body, "htmx:oobErrorNoTarget", {
                content: o
            })
        }
        return e
    ...
    function $e(h, d, p, g) {
        ...
        if (t && ae(r, "htmx:beforeTransition", g.eventInfo) && typeof Promise !== "undefined" && document.startViewTransition) {
    ...
    function ht(e, t) {
        if (e.type === "submit" || e.type === "click") {
            ...
            if (t instanceof HTMLAnchorElement && t.href && (t.getAttribute("href") === "#" || t.getAttribute("href").indexOf("#") !== 0)) {
                return true
            }
        }
        return false
    ...
    function pt(e, t, n) {
        ...
        if (r) {
            try {
                ...
                const o = r.source;
                fe(te().body, "htmx:eventFilter:error", {
                    error: e,
                    source: o
                });
                return true
    ...
    function Rt(e) {
        if (e.querySelectorAll) {
            ...
            const o = e.querySelectorAll(T + n + ", form, [type='submit']," + " [hx-ext], [data-hx-ext], [hx-trigger], [data-hx-trigger]" + r.flat().map(e => ", " + e).join(""));
            return o
        } else {
            return []
        }
    ...
    function $t(t, e) {
        ...
        ae(te().body, "htmx:historyItemCreated", {
            item: s,
            cache: i
        });
        i.push(s);
        ...
        while (i.length > 0) {
            try {
                ...
                fe(te().body, "htmx:historyCacheError", {
                    cause: e,
                    cache: i
                });
                i.shift()
    ...
    function Gt() {
        ...
        if (!n) {
            ae(te().body, "htmx:beforeHistorySave", {
                path: t,
                historyElt: e
            });
            $t(t, e)
    ...
    function An(t) {
        if (t.responseURL) {
            try {
                ...
                fe(te().body, "htmx:badResponseUrl", {
                    url: t.responseURL
                })
            }
        }
    ...
    function In(e, t, n) {
        ...
        return ae(e, "htmx:validateUrl", le({
            url: r,
            sameHost: i
        }, n))
    }
    ...
    function he(t, n, r, o, i, k) {
        ...
        g.onload = function () {
            try {
                const t = Nn(r);
                R.pathInfo.responsePath = An(g);
                M(r, R);
                if (R.keepIndicators !== true) {
                    rn(T, q)
                }
                ae(r, "htmx:afterRequest", R);
                ae(r, "htmx:afterOnLoad", R);
                if (!se(r)) {
                    let e = null;
                    ...
                    if (e) {
                        ae(e, "htmx:afterRequest", R);
                        ae(e, "htmx:afterOnLoad", R)
                    }
                }
                re(s)
            } catch (e) {
                fe(r, "htmx:onLoadError", le({
                    error: e
                }, R));
                throw e
            } finally {
        ...
        g.onerror = function () {
            rn(T, q);
            fe(r, "htmx:afterRequest", R);
            fe(r, "htmx:sendError", R);
            re(l);
            m()
        };
        g.onabort = function () {
    ...
    function jn(t, e) {
        ...
        const l = R(n, /HX-Refresh:/i) && n.getResponseHeader("HX-Refresh") === "true";
        if (R(n, /HX-Redirect:/i)) {
        ...
        if (m.shouldSwap) {
            ...
            $e(r, g, y, {
                ...
                afterSwapCallback: function () {
                    if (R(n, /HX-Trigger-After-Swap:/i)) {
                        let e = t;
                        if (!se(t)) {
                            e = te().body
                        }
                ...
                afterSettleCallback: function () {
                    if (R(n, /HX-Trigger-After-Settle:/i)) {
                        let e = t;
                        if (!se(t)) {
                            e = te().body
                        }
                ...
                beforeSwapCallback: function () {
                    if (c.type) {
                        ae(te().body, "htmx:beforeHistoryUpdate", le({
                            history: c
                        }, e));
                        if (c.type === "push") {
                            Wt(c.path);
                            ae(te().body, "htmx:pushedIntoHistory", {
                                path: c.path
                            })
                        } else {
                            Zt(c.path);
                            ae(te().body, "htmx:replacedInHistory", {
                                path: c.path
                            })
                        }
                    }
    ...
    function Wn() {
        if (Q.config.includeIndicatorStyles !== false) {
            ...
            te().head.insertAdjacentHTML("beforeend", "<style" + e + ">      ." + Q.config.indicatorClass + "{opacity:0}      ." + Q.config.requestClass + " ." + Q.config.indicatorClass + "{opacity:1; transition: opacity 200ms ease-in;}      ." + Q.config.requestClass + "." + Q.config.indicatorClass + "{opacity:1; transition: opacity 200ms ease-in;}      </style>")
        }
    }
    ...
    Gn(function () {
        ...
        let e = te().body;
        Ft(e);
        const t = te().querySelectorAll("[hx-trigger='restored'],[data-hx-trigger='restored']");
